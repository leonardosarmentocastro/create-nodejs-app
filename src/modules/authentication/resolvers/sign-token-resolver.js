...
// The gotcha behind the exposed interface would be through `req.createdUser || signedInUser`
...
// the ones we have seem on code so far: `req.createdUser || req.signedInUser`.
